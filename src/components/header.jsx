  ...
  return (
    <header className="flex justify-between bg-white px-6 py-7 text-sm shadow-md dark:bg-darkBlue md:px-10 md:py-6 lg:px-20">
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        >
          <svg
            className={`absolute h-4 w-4 fill-white transition-all ${
          ...
          <svg
            className={`h-4 w-4 transition-all ${darkMode ? "scale-0" : "scale-100"}`}
            height="800px"
            width="800px"
            version="1.1"
            id="Capa_1"
          ...
          <label className="font-bold dark:text-white md:text-base">
            Dark mode
          </label>
        </button>
      </div>
